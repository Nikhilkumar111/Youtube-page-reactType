...
const links = [
     ...
     {
      href: "https://www.youtube.com/@Algobitcoder",
      label: "YouTube",
      icon: <FaYoutube className="h-6 w-6 text-red-600" />,
    },
    {
      href: "https://github.com/Nikhilkumar111",
      label: "GitHub",
      icon: <FaGithub className="h-6 w-6 text-gray-900" />,
    },
     {
      href: "https://www.linkedin.com/in/nikhil-kumar-37b182253/",
      label: "Linkdin",
      icon: <FaLinkedin  className="h-6 w-6 text-pink-500" />,
    },
];
